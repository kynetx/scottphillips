const CLASSNAME = "KN_KynetxService";
const CONTRACTID = "@kynetx.mozdev.org/kynetx-service;1";
...
var kynetxService = {
  ...
  QueryInterface: function(aIID) {
    if (!aIID.equals(Ci.nsIObserver) &&
        ...
        !aIID.equals(Ci.gmIKynetxService) &&
  ...
  startup: function() {
    ...
    loader.loadSubScript("chrome://kynetx/content/prefmanager.js");
    loader.loadSubScript("chrome://kynetx/content/utils.js");
    loader.loadSubScript("chrome://kynetx/content/config.js");
    loader.loadSubScript("chrome://kynetx/content/script.js");
    loader.loadSubScript("chrome://kynetx/content/scriptrequire.js");
    loader.loadSubScript("chrome://kynetx/content/scriptresource.js");
    loader.loadSubScript("chrome://kynetx/content/convert2RegExp.js");
    loader.loadSubScript("chrome://kynetx/content/miscapis.js");
    loader.loadSubScript("chrome://kynetx/content/xmlhttprequester.js");
    loader.loadSubScript("chrome://kynetx/content/scriptdownloader.js");
  },

  shouldLoad: function(ct, cl, org, ctx, mt, ext) {
    var ret = Ci.nsIContentPolicy.ACCEPT;

    // block content detection of kynetx by denying GM
...
kynetxService.wrappedJSObject = kynetxService;
