...
If you have downloaded a version of the AIR 2 SDK that contains the Packager for iPhone functionality, additional files will be included. The following files and folders in the AIR 2.0.1 SDK contain the tools that enable you to compile AIR applications into .ipa files for iPhone OS devices.

BIN
 - pfi - The Packager for iPhone packages your application as an .ipa file for iPhone OS devices.  

LIB
 - AOT - Directory containing the files necessary for the AOT (Ahead of Time) Compiler used by Packager for iPhone
 - pfi.jar - The PFI library file, used by the pfi executable
