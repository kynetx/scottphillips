...
class ClientApplication < ActiveRecord::Base
  ...
  before_destroy :remove_from_peer
  ...
  def oauth_server
    # this is where the access, request, and authorize tokens come from
    # you are going to need to override this from the 'oauth/server.rb' to 
