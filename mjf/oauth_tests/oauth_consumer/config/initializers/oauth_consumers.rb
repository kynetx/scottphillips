OAUTH_CREDENTIALS={
  :twitter=>{
    :key=>"Rz2o2jUZkgY77pUKi6GdxQ",
    :secret=>"mOK2TEwCKBzJzJkUV0O6EbGAt73kmJK3gDcB3issMA",
    :site=>"http://twitter.com"
  },
  :testlocal=> {
      :key=>"CYi3MVg1M917QpGacfiK",
      :secret=>"YMsdx8njQj5nOJdKF0m9On48SsYWDot18lv3TW1r",
      :options => {:site => "http://accounts-staging.kynetx.com"}
  }
}
